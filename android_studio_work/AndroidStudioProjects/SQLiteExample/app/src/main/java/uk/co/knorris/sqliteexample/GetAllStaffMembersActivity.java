...
public class GetAllStaffMembersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allStaffMembersCustomAdapter = new AllStaffMembersCustomAdapter(this,staffMemberModelArrayList);
        listView.setAdapter(allStaffMembersCustomAdapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(GetAllStaffMembersActivity.this, UpdateDeleteActivity.class);

                Toast.makeText(GetAllStaffMembersActivity.this,
                           "Passing (.putExtra) staff member at " + Integer.toString(position) + "\n" +
                                "which is :\n" +
