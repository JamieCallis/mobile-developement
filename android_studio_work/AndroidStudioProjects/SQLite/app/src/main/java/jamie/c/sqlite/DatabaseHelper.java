...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /*
        This could be split into it's own class especially if there is more than one table that is needed.
        Each table should have it's own class that Database Helper uses.
    ...
    /* core function to DatabaseHelper Class */
    ...
    // can be modulated
    public void addStaffMember(String firstName,
                               String lastName,
                               String officeNumber) {
    ...
    public ArrayList<StaffMemberModel> getAllStaffMembers() {
        ...
        ArrayList<StaffMemberModel> staffMemberModelArrayList = new
                ArrayList<StaffMemberModel>();
    ...
    // can be modulated
    public void updateStaffMember(int id,
                                  String firstName,
                                  String lastName,
                                  String officeNumber) {
    ...
    public void deleteStaffMember(int id) {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(DATABASE_TABLE_STAFF,
                KEY_ID + " = ?",
